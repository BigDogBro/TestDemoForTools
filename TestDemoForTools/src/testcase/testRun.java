...
public class testRun {
	...
	public static void main(String[] args) {
		...
		String strBuild = "cmd /c cd C:\\Users\\wenli\\workspace\\TestDemo\\ && ant build";
		String strRun = "cmd /c adb push C:\\Users\\wenli\\workspace\\TestDemo\\bin\\demo.jar "
				+ "/data/local/tmp && adb shell uiautomator runtest demo.jar --nohup -c "
				+ "testcase.startTest";
		try {
